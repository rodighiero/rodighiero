...
For every WebP under images/ (excluding @cards/, which is wholly generated by
scripts/generate-thumbnails.py, and @icons/), this re-encodes at:
...
fidelity, but it keeps provenance clean).
"""
