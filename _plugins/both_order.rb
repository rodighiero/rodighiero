# Publishes `site.data['ordered_publications']`, and `prev_pub`/`next_pub` on each doc.
#
...
Jekyll::Hooks.register :site, :post_read do |site|
  ...
  ordered = Jekyll::OrderedPublications.order(docs)
  Jekyll::OrderedPublications.link_neighbours(ordered)
