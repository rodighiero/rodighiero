...
---
{% include figure-single.html class="wide" src="/images/@cards/Grounding-AI.webp" alt="Title card for “Grounding AI: Exploring the Role of Algorithms in Science,” set over an iridescent microscopic texture on a blue-grey gradient" %}
