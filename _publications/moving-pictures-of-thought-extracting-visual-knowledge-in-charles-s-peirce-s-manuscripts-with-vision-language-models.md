...
issn: "3070-8931"
thumb: "moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_001.webp"
redirect_from:
...
{% include figure-single.html class="full" src="/images/moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_001.webp" caption="Figure 1. Paul Klee’s Theory of Pictorial Configuration as a diagram. Zentrum Paul Klee, Bern, Inv.Nr. BG A/030. Photo: Zentrum Paul Klee." %}
...
To prepare the corpus for computational processing, we retrieved IIIF metadata for each digitized item, including canvas structure, image URIs, and classification labels derived from Robin’s catalog (Robin 1971). All canvases were downloaded at full resolution and organized into thematic folders. Blank pages, identified using IIIF metadata, were automatically excluded, resulting in a set of 13,234 manuscript pages (Table 1).
...
{% include figure-single.html class="three-quarter" src="/images/moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_003.webp" caption="Figure 3. Distribution of digitized manuscript pages across Peirce’s lifetime, grouped by five-year intervals and categorized according to Robin’s classification. Based on IIIF canvas data, the visualization highlights how Peirce’s intellectual focus evolved over time, with Logic manuscripts dominating the corpus and peaks corresponding to his most productive years in formal reasoning." %}
...
{% include figure-single.html class="three-quarter" src="/images/moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_004.webp" caption="Figure 4. Pie charts showing the distribution of text and diagrams within three categories." %}
...
{% include figure-single.html class="wide" src="/images/moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_005.webp" caption="Figure 5. Output of the fine-tuned YOLOv8m model on an autograph manuscript dated 1902. MS Am 1632 (430), Box 29, Folder 28, Series I. Manuscripts, D. Logic. Houghton Library, Harvard University. Photo: © Houghton Library. Persistent URL: http://nrs.harvard.edu/urn-3:FHCL.HOUGH:12491033. The model correctly identifies and segments “diagram” (blue) and “text_block” (light blue) regions, providing the structured data used for subsequent annotation and VLM analysis." %}
...
{% include figure-single.html class="three-quarter" src="/images/moving-pictures-of-thought-extracting-visual-knowledge-in-charles-s-peirce-s-manuscripts-with-vision-language-models/fig_006.webp" caption="Figure 6. Example diagram from Peirce’s Logic manuscripts, used for evaluating the interpretative capacity of VLMs." %}
...
- Aouinti, Fouad, Victoria Eyharabide, Xavier Fresquet, and Frédéric Billiet. 2022. “Illumination Detection in IIIF Medieval Manuscripts Using Deep Learning.” _Digital Medievalist_ 15 (1): 1–18. https://doi.org/10.16995/dm.8073
...
- Harvard University. 2023. “Charles S. Peirce Papers.” Accessed April 4, 2025. https://hollisarchives.lib.harvard.edu/repositories/24/resources/6437 ([archived](https://web.archive.org/web/20240219054446/https://hollisarchives.lib.harvard.edu/repositories/24/resources/6437))
...
- Ravichandra, S., S. Siva Sathya, and L. Sophie. 2022. “Deep Learning Based Document Layout Analysis on Historical Documents.” In _Advances in Distributed Computing and Machine Learning_, 271–281. Singapore: Springer. https://doi.org/10.1007/978-981-19-1018-0_23
