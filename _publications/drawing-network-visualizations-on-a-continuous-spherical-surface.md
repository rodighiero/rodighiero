...
{% include figure-single.html class="wide" src="/images/drawing-network-visualizations-on-a-continuous-spherical-surface/fig_008.webp" caption="Figure 8. Butterfly of Waterman." %}

{% include figure-single.html class="wide" src="/images/drawing-network-visualizations-on-a-continuous-spherical-surface/fig_009.webp" caption="Figure 9. Conic equal-area." %}

{% include figure-single.html class="wide" src="/images/drawing-network-visualizations-on-a-continuous-spherical-surface/fig_010.webp" caption="Figure 10. Dodecahedral." %}

{% include figure-single.html class="wide" src="/images/drawing-network-visualizations-on-a-continuous-spherical-surface/fig_011.webp" caption="Figure 11. Icosahedral." %}

{% include figure-single.html class="wide" src="/images/drawing-network-visualizations-on-a-continuous-spherical-surface/fig_012.webp" caption="Figure 12. Lee’s tetrahedral." %}
