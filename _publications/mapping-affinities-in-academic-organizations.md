...
{% include figure-single.html class="wide" src="/images/mapping-affinities-in-academic-organizations/fig_001.webp" caption="Figure 1. The Affinity Map of the School of Architecture, Civil and Environmental Engineering school. The arrangement is the result of three forces (relational, repulsive, and gravitational) applied to each node. The general arrangement shows the closeness of the laboratories according to actual and potential affinities." %}
...
{% include figure-single.html class="wide" src="/images/mapping-affinities-in-academic-organizations/fig_003.webp" caption="Figure 3. Keywords between laboratories indicate potential affinities. Zooming makes visible the keywords that correspond to laboratory common lexicon. Using the spatialization of the hexagonal grid, keywords adds a further information level that expresses the semantic of the map." %}
...
{% include figure-single.html class="three-quarter" src="/images/mapping-affinities-in-academic-organizations/fig_006.webp" caption="Figure 6. The cycle of the visualization combines mapmaker and reader." %}
...
{% include figure-single.html class="wide" src="/images/mapping-affinities-in-academic-organizations/fig_007.webp" caption="Figure 7. Different configurations of reading. On the left, a set of configurations schematizes the relation between the reader and its image, covering the actualization of the screen and the poster. On the right, we simulate a potential interaction of a collective representing itself, which corresponds to the carpet actualization." %}
