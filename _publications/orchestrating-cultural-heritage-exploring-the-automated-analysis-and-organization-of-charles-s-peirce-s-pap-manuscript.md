...
isbn: "9798400702327"
thumb: orchestrating-cultural-heritage-exploring-the-automated-analysis-and-organization-of-charles-s-peirce-s-pap-manuscript/cover.webp
redirect_from:
  - /Peirce-s-PAP
  - /orchestrating-cultural-heritage-exploring-the-automated-analysis-and-organization-of-charles-s-peirces-pap-manuscript
---
...
{% include figure-single.html class="three-quarter" src="/images/orchestrating-cultural-heritage-exploring-the-automated-analysis-and-organization-of-charles-s-peirce-s-pap-manuscript/fig_001.webp" alt="A triangular correlation matrix of 56 manuscript pages, with cells shaded from gray (low similarity) to red (high similarity) along the color scale." caption="Figure 1. Correlation matrix showing the semantic proximity of pages to each other. Variants have been aggregated." %}
...
{% include figure-single.html class="three-quarter" src="/images/orchestrating-cultural-heritage-exploring-the-automated-analysis-and-organization-of-charles-s-peirce-s-pap-manuscript/fig_003.webp" alt="A scatter plot of numbered manuscript pages positioned by similarity across a two-dimensional plane, forming loose clusters." caption="Figure 3. The UMAP algorithm maps PAP manuscripts according to similarity." %}
...
{% include figure-single.html class="wide" src="/images/orchestrating-cultural-heritage-exploring-the-automated-analysis-and-organization-of-charles-s-peirce-s-pap-manuscript/fig_004.webp" alt="A web-based visualization of the UMAP embedding with contour lines enclosing four clusters, each labeled by a word cloud of its most frequent terms such as “reasoning”, “thought”, “definition”, and “relation”." caption="Figure 4. This web-based application allows the user to see the UMAP embedding with new graphical elements that resemble a visual classification of the PAP manuscript pages." %}
...
- Harvard University. 2023. “Charles S. Peirce Papers.” HOLLIS for Archival Discovery. Accessed March 8, 2023. https://hollisarchives.lib.harvard.edu/repositories/24/resources/6437 ([archived](https://web.archive.org/web/20240219054446/https://hollisarchives.lib.harvard.edu/repositories/24/resources/6437))
- Houser, Nathan. 1989. “The Fortunes and Misfortunes of the Peirce Papers.” Arisbe: The Peirce Gateway. https://arisbe.sitehost.iu.edu/menu/library/aboutcsp/houser/fortunes.htm ([archived](https://web.archive.org/web/20210617175933/https://arisbe.sitehost.iu.edu/menu/library/aboutcsp/houser/fortunes.htm))
...
- Peirce Edition Project. 2021. “Peirce Edition Project.” https://peirce.iupui.edu/ ([archived](https://web.archive.org/web/20260118220533/https://peirce.iupui.edu/))
- Picca, Davide, Alessandro Adamou, Yumeng Hou, Mattia Egloff, and Sarah Kenderdine. 2022. “Knowledge Organization of the Hong Kong Martial Arts Living Archive to Capture and Preserve Intangible Cultural Heritage.” In _Digital Humanities 2022: Conference Abstracts_, 329–32. Tokyo: University of Tokyo. https://dh2022.dhii.asia/abstracts/files/PICCA_Davide_Knowledge_organization_of_the_Hong_Kong_Martial.html ([archived](https://web.archive.org/web/20230811211758/https://dh2022.dhii.asia/abstracts/files/PICCA_Davide_Knowledge_organization_of_the_Hong_Kong_Martial.html))
- Robin, Richard S. 1967. _Annotated Catalogue of the Papers of Charles S. Peirce_. https://peirce.sitehost.iu.edu/robin/rcatalog.htm ([archived](https://web.archive.org/web/20231203074204/https://peirce.sitehost.iu.edu/robin/rcatalog.htm))
